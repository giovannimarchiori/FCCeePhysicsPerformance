...
processList = {
    #"p8_ee_Zcc_ecm91": {}, # ccbar background
...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        df2 = (
            ...
            .Filter("nRecoPions>2") # Only keep events with exactly 3 reconstructed pions
            ...
            #.Filter("TauMass_allCandidates<2")
            # count photons
            .Alias("Photon0","Photon#0.index")
            .Define("photons",
                    "ReconstructedParticle::get(Photon0, ReconstructedParticles)")
            .Define("n_photons", "ReconstructedParticle::get_n(photons)")
            .Define("diphotons", "VtxAna::build_diphotons(photons,0.,1.)")
            .Define("n_diphotons", "return diphotons.size();")
            .Filter("n_diphotons>0")
            .Define("diphoton_p4vis", "VtxAna::diphoton_p4vis(diphotons)")
            .Define("diphoton_mass", "VtxAna::p4_mass(diphoton_p4vis)")
            .Define("diphoton_px", "VtxAna::p4_px(diphoton_p4vis)")
            .Define("diphoton_py", "VtxAna::p4_py(diphoton_p4vis)")
            .Define("diphoton_pz", "VtxAna::p4_pz(diphoton_p4vis)")
            .Define("diphoton_pt", "VtxAna::p4_pz(diphoton_p4vis)")
            .Define("taus_vis","VtxAna::build_taus(diphotons,triplets,1)")
            .Define("taus_p4vis","VtxAna::taus_p4vis(taus_vis)")
            .Define("taus_mass","VtxAna::p4_mass(taus_p4vis)")
            # count muons
    ...
    def output():
        ...
        '''
        branchList = [
            "n_triplets","n_photons","n_muons","n_electrons","n_diphotons","diphoton_mass",
