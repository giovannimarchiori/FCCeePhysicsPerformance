...
#inputDir    = "/afs/cern.ch/user/a/aumarten/eos/fcc-tau/samples"
outputDir   = "result"
...
class RDFanalysis():
    ...
    def analysers(dframe):
        ...
        dframe0 = (
            dframe
            .Filter("0 < rdfentry_ && rdfentry_<= 100000000") # USE EVEN SMALLER SUBSET OF THE SAMPLE (FAST CODE TESTING)
            ...
            # the tau :
            .Define("MC_tau", "return Particle.at(MCtau3pinu_indices[0]);")
            .Define("MC_Pion1", "return Particle.at(MCtau3pinu_indices[2]);")
            .Define("MC_tau3pi_invMass", "VtxAna::tau3pi_MC_mass(MCtau3pinu_indices,Particle)")
        ...
        ##dframe0 = (
            dframe0
            .Define("MCtauMinus","MCParticle::sel_pdgID(15,false)(Particle)")
            .Define("MCtauPlus","MCParticle::sel_pdgID(-15,false)(Particle)")
        ...
        #    .Define("MCTauMinus_px","MCParticle::get_px(MCtauMinus)[0]")
       ...
       # )
        print(f"MC Tau^- --> pi^- pi^+ pi^- nu_tau and CC : {dframe0.Count().GetValue()}")
      ...
      #  RDFanalysis.output_var.extend(["MCTauPlus_px","MCTauPlus_py","MCTauPlus_pz","MCTauPlus_E"])
        ...
        dframe2 = (
            ...
            dframe0.Define("TauRecoParticles",
                    "ReconstructedParticle2MC::selRP_matched_to_list(MCtau3pinu_indices, RecoIndex, MCIndex, ReconstructedParticles, Particle)")
            ...
            .Define("invMass_3pi_raw", "VtxAna::tau3pi_raw_mass(TauRecoParticles)")
            .Define("NuTauMass2_allCandidates",
                    "VtxAna::build_neutrinoMassSquared(TauVertexObject)")
            .Define("NuTauMass2_trueVertex",
                    "VtxAna::build_neutrinoMassSquared(TauVertexObject,TauMCDecayVertex)")
                    
            #.Define('RP_MC_index', "ReconstructedParticle2MC::getRP2MC_index(RecoIndex,MCIndex,ReconstructedParticles)")
        
        )
        print(f"Reco-ed tau->3pi (mc-seeded): {dframe2.Count().GetValue()}")
        RDFanalysis.output_var.extend(["invMass_3pi_fit","invMass_3pi_raw","TauVertex_chi2","TauVertex_x","TauVertex_y","TauVertex_z","TauVertexCharge","NuTauMass2_allCandidates","NuTauMass2_trueVertex"])
